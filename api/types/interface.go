...
type SDK interface {
	...
	// Reconnect is hard reset of the current connection, it closes the current connection,
	// opens a new one, and resends the last hello message. No message buffering, just hard reconnect!
	Reconnect() (err error)
